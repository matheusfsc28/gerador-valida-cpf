...
var GeraCPF = /*#__PURE__*/function () {
  ...
  _createClass(GeraCPF, [{
    ...
    value: function geraNovoCpf() {
      ...
      var novoCpf = "".concat(cpfSemDigito).concat(digito1).concat(digito2);
...
.cpf-valido{
  ...
  font-weight: bold;
  font-size: 22px;
}`, "",{"version":3,"sources":["webpack://./src/assets/css/style.css"],"names":[],"mappings":"AAEA;EACE,wBAAwB;EACxB,sCAAsC;AACxC;;AAEA;EACE,sBAAsB;EACtB,UAAU;AACZ;;AAEA;EACE,SAAS;EACT,UAAU;EACV,gCAAgC;EAChC,oCAAoC;EACpC,gBAAgB;EAChB,kBAAkB;AACpB;;AAEA;EACE,gBAAgB;EAChB,kBAAkB;EAClB,gBAAgB;EAChB,aAAa;EACb,mBAAmB;EACnB,oBAAoB;EACpB,kBAAkB;EAClB,qBAAqB;AACvB;;AAEA;;;EAGE,cAAc;EACd,WAAW;EACX,mBAAmB;AACrB;;AAEA;EACE,eAAe;EACf,YAAY;EACZ,eAAe;AACjB;;AAEA;EACE,uCAAuC;AACzC;;AAEA;EACE,YAAY;EACZ,gCAAgC;EAChC,WAAW;EACX,eAAe;EACf,gBAAgB;EAChB,YAAY;EACZ,eAAe;EACf,gBAAgB;AAClB;;AAEA;EACE,uCAAuC;AACzC;;AAEA;EACE,WAAW;AACb;;AAEA;EACE,kBAAkB;EAClB,mBAAmB;EACnB,gBAAgB;AAClB;;AAEA;EACE,eAAe;EACf,YAAY;EACZ,uBAAuB;EACvB,kBAAkB;EAClB,eAAe;AACjB;;AAEA;EACE,6BAA6B;EAC7B,4BAA4B;AAC9B;;AAEA;EACE,eAAe;EACf,YAAY;EACZ,uBAAuB;EACvB,kBAAkB;EAClB,eAAe;AACjB;;AAEA;EACE,6BAA6B;EAC7B,4BAA4B;AAC9B;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,kBAAkB;EAClB,UAAU;EACV,eAAe;EACf,kCAAkC;EAClC,iBAAiB;EACjB,kBAAkB;EAClB,gBAAgB;EAChB,iBAAiB;EACjB,mBAAmB;EACnB,2BAA2B;AAC7B;;AAEA;EACE,2BAA2B;EAC3B,iBAAiB;EACjB,eAAe;AACjB","sourcesContent":["@import url('https://fonts.googleapis.com/css?family=Open+Sans:400,700&display=swap');\n\n:root {\n  --primary-color: #2b3468;\n  --primary-color-darker: rgb(9, 48, 56);\n}\n\n* {\n  box-sizing: border-box;\n  outline: 0;\n}\n\nbody {\n  margin: 0;\n  padding: 0;\n  background: var(--primary-color);\n  font-family: 'Open sans', sans-serif;\n  font-size: 1.3em;\n  line-height: 1.5em;\n}\n\n.container {\n  max-width: 640px;\n  margin: 200px auto;\n  background: #fff;\n  padding: 20px;\n  border-radius: 10px;\n  border-style: dashed;\n  text-align: center;\n  border-color: #2b3468;\n}\n\nform input,\nform label,\nform button {\n  display: block;\n  width: 100%;\n  margin-bottom: 10px;\n}\n\nform input {\n  font-size: 24px;\n  height: 50px;\n  padding: 0 20px;\n}\n\nform input:focus {\n  outline: 1px solid var(--primary-color);\n}\n\nform button {\n  border: none;\n  background: var(--primary-color);\n  color: #fff;\n  font-size: 18px;\n  font-weight: 700;\n  height: 50px;\n  cursor: pointer;\n  margin-top: 30px;\n}\n\nform button:hover {\n  background: var(--primary-color-darker);\n}\n\ntable {\n  width: 100%;\n}\n\n.bot-cont {\n  text-align: center;\n  margin-bottom: 25px;\n  margin-top: 25px;\n}\n\n.botao-gerar {\n  font-size: 20px;\n  color: black;\n  border: 1px solid black;\n  border-radius: 5px;\n  cursor: pointer;\n}\n\n.botao-gerar:hover {\n  background-color: greenyellow;\n  transition: all 0.5s ease-in;\n}\n\n.botao-validar {\n  font-size: 20px;\n  color: black;\n  border: 1px solid black;\n  border-radius: 5px;\n  cursor: pointer;\n}\n\n.botao-validar:hover {\n  background-color: greenyellow;\n  transition: all 0.5s ease-in;\n}\n\n.input-cpf {\n  text-align: center;\n}\n\n.text-cpf {\n  text-align: center;\n  width: 50%;\n  font-size: 25px;\n  border-color: var(--primary-color);\n  border-left: none;\n  border-right: none;\n  border-top: none;\n  font-weight: bold;\n  letter-spacing: 3px;\n  color: var(--primary-color);\n}\n\n.cpf-valido{\n  color: var(--primary-color);\n  font-weight: bold;\n  font-size: 22px;\n}"],"sourceRoot":""}]);
// Exports
...
var CPF = document.querySelector('.text-cpf');
var botaoGerar = document.querySelector('.botao-gerar');
botaoGerar.addEventListener('click', function (e) {
  e.preventDefault();
...
botaoValidar.addEventListener('click', function (e) {
  e.preventDefault();
  var cpf = new _modules_ValidaCPF__WEBPACK_IMPORTED_MODULE_1__["default"](CPF.value);
  if (cpf.valida()) {
    var cpfValido = document.querySelector('.cpf-valido');
    cpfValido.innerHTML = 'CPF VALIDO';
  } else {
    var cpfInvalido = document.querySelector('.cpf-valido');
